...
public class hesapMakinesi {
	...
	static void mod() {
		...
		int litNumber = scan.nextInt();
		int result = 1;
		if (bigNumber < litNumber) {
			System.out.println("İlk Sayı İkinci Sayıdan Küçük Olamaz");
		} else {
			result = bigNumber % litNumber;
			System.out.println("Sonuç : " + result);
		}
	...
	static void rectangle() {
		...
		int result = 1;
		System.out.println("Dikdörtgenin Çevresi: " + (2 * (longEdge + shortEdge)));
